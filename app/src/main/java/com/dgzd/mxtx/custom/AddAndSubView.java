...
public class AddAndSubView extends LinearLayout
{
	...
	private void initialise()
	{
		...
		subButton = new TextView(context);
        tvNum = new TextView(context);

		addButton.setText("+");
		subButton.setText("-");
		addButton.setPadding(3, 3, 3, 3);
		subButton.setPadding(3, 3, 3, 3);
		addButton.setTag("+");
		subButton.setTag("-");
	...
	private void setViewsLayoutParm()
	{
        ...
        tvNum.setLayoutParams(viewLayoutParams);
	...
	private void setTextWidthHeight()
	{
        ...
        tvNum.setMinimumWidth(dip2px(context, editTextMinimumWidth));
		...
		if (editTextHeight > 0)
		{
            ...
            tvNum.setHeight(dip2px(context, editTextHeight));
		}
		...
		if (editTextLayoutHeight > 0)
		{
			...
			LayoutParams layoutParams = (LayoutParams) tvNum
					.getLayoutParams();
	...
	private void insertView()
	{
		...
		centerLinearLayout.addView(tvNum);
	...
	public int getNum()
	{
		if (tvNum.getText().toString() != null)
		{
	...
	public void setEditTextMinimumHeight(int editTextMinimumHeight)
	{
		...
		if (editTextMinimumHeight > 0)
		{
            ...
            tvNum.setMinimumHeight(dip2px(context, editTextMinimumHeight));
		}
	}
	...
	public void setEditTextMinHeight(int editTextMinHeight)
	{
		...
		if (editTextMinHeight > 0)
		{
            ...
            tvNum.setMinHeight(dip2px(context, editTextMinHeight));
		}
	}
...
//        tvNum.addTextChangedListener(new OnTextChangeListener());
	}
	...
	class OnButtonClickListener implements OnClickListener
	{
		...
		{
			String numString = tvNum.getText().toString();
			...
			} else
			{
				if (v.getTag().equals("+"))
				{
					...
					} else
					{
                        if(num > maxNum){
                            num--;
                            Toast.makeText(context, "亲，数量有限哦",
                                    Toast.LENGTH_SHORT).show();
                        }else{
                            tvNum.setText(String.valueOf(num));
