 ...
 *
 */
public class RecursionRadioGroup extends LinearLayout
{
		 ...
		 * {@inheritDoc}
		 */
		public RecursionRadioGroup(Context context) {
			super(context);
			init();
		}
		 ...
		 * {@inheritDoc}
		 */
		public RecursionRadioGroup(Context context, AttributeSet attrs) {
			super(context, attrs);
			init();
		}
		...
		public LayoutParams generateLayoutParams(AttributeSet attrs) {
			return new RecursionRadioGroup.LayoutParams(getContext(), attrs);
		}
		...
		protected boolean checkLayoutParams(ViewGroup.LayoutParams p) {
			return p instanceof RecursionRadioGroup.LayoutParams;
		}
		...
		public interface OnCheckedChangeListener {
			 ...
			 */
			public void onCheckedChanged(RecursionRadioGroup group, int checkedId);
		}
		...
		private class PassThroughHierarchyChangeListener implements ViewGroup.OnHierarchyChangeListener {
			...
			public void onChildViewAdded(View parent, View child) {
				if (parent == RecursionRadioGroup.this) {
