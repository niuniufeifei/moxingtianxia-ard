...
import com.dgzd.mxtx.custom.MovieRecorderView;


public class StartTackMovieActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_explor_start_take_movie);
            ...
            public boolean onTouch(View v, MotionEvent event) {
                if (event.getAction() == MotionEvent.ACTION_DOWN) {
                    ...
                    if (mRecorderView.getTimeCount() > 5)
                        ...
                        mRecorderView.stop();
                        Toast.makeText(StartTackMovieActivity.this, "视频录制时间太短", Toast.LENGTH_SHORT).show();
                    }
                }
                return true;
            }
    ...
    private void finishActivity() {
        if (isFinish) {
            mRecorderView.stop();
            //跳转到发送界面
//            Intent intent = new Intent(StartTackMovieActivity.this, TravelGroupSendMovieActivity.class);
//            Bundle bundle = new Bundle();
//            bundle.putString("path", mRecorderView.getmRecordFile().getAbsolutePath());
//            intent.putExtras(bundle);
//            StartTackMovieActivity.this.startActivity(intent);
            this.finish();
        }
        // isFinish = false;
        finish();
