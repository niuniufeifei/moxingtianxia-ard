...
/**
 * @version V1.0 <装备>
 * @FileName: MotoGearActivity.java
 * @author: Jessica
 * @date: 2016-01-21 16:47
 */

public class MotoGearActivity extends AppCompatActivity implements XScrollView.IXScrollViewListener {
    ...
    private final String requestTag = "MotoGearActivity";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_moto_gear);
    ...
    private void getCommodityData(final int status) {
        String commodityUrl = String.format(GlobalEntity.commodityListInfo2Url, mRefreshIndex, "", 10);
