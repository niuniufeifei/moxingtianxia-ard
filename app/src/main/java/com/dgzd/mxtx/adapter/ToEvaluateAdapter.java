...
public class ToEvaluateAdapter extends BaseAdapter {
    ...
    private final String requestTag = "ToEvaluateAdapter";

    public ToEvaluateAdapter(List<UserOrderInfo> commodityViewArray, Context context) {
        super();
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = mInflater.inflate(
                    R.layout.custom_user_order_to_evaluate_item, null);
