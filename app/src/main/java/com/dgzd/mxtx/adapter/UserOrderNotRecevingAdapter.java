...
public class UserOrderNotRecevingAdapter extends BaseAdapter {
    ...
    public UserOrderNotRecevingAdapter(List<UserOrderInfo> commodityViewArray, Context context) {
        super();
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = mInflater.inflate(
                    R.layout.custom_user_order_not_receving_item, null);
            ...
            holder.tvCheckLogistics = (TextView) convertView.findViewById(R.id.tv_check_logistics);
            holder.tvConfirmReceipt = (TextView) convertView.findViewById(R.id.tv_confirm_receipt);
        ...
        holder.tvConfirmReceipt.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
