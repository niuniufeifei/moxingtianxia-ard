...
public class UserOrderAdapter extends BaseAdapter {
    ...
    public UserOrderAdapter(List<UserOrderInfo> commodityViewArray, Context context) {
        super();
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = mInflater.inflate(
                    R.layout.custom_user_order_item, null);
        ...
        holder.ivIcon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //commodityViewArray
                RongIM.getInstance().startConversation(context, Conversation.ConversationType.PRIVATE, String.valueOf(commodityViewArray.get(position).getUserid()), commodityViewArray.get(position).getShopName());
            }
        });
