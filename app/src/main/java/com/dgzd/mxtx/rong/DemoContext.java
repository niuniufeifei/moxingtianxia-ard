  ...
  /*  public void deleteUserInfos() {
   ...
   /* public UserInfos getUserInfosById(String userId) {
    ...
    public UserInfo getUserInfoById(String userId) {
        ...
        if (userId == null)
            return null;
        com.dgzd.mxtx.rong.model.UserInfo userInfos = null;
        ...
        Log.d("DemoContext.class", "HeadImage-url:" + userInfos.getAvatar()+"---id"+String.valueOf(userInfos.getId())+"---name"+userInfos.getUsername());
        return new UserInfo(String.valueOf(userInfos.getUid()), userInfos.getUsername(), Uri.parse(userInfos.getAvatar()));
    }
