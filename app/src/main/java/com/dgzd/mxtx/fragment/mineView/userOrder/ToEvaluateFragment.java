...
import com.dgzd.mxtx.adapter.ToEvaluateAdapter;
...
public class ToEvaluateFragment extends Fragment implements XScrollView.IXScrollViewListener {
    private View view;
    ...
    private final String requestTag = "ToEvaluateFragment";
    private MxtxApplictaion myApp;

    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_user_order_to_evaluate, container, false);
    ...
    private Handler myHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case 1: {
                    adapter = new ToEvaluateAdapter(orderList, getActivity());
