...
import com.dgzd.mxtx.adapter.UserOrderNotRecevingAdapter;
...
public class NotReceivingFragment extends Fragment implements XScrollView.IXScrollViewListener{
    private View view;
    private Handler mHandler;
    private ListView lvMyOrder;
    private List<UserOrderInfo> orderList = new ArrayList<>();
    private UserOrderNotRecevingAdapter adapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_user_order_not_receiving, container, false);
    ...
    private Handler myHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case 1: {
                    adapter = new UserOrderNotRecevingAdapter(orderList, getActivity());
